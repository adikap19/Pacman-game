...
public:
	...
	void initVectors(std::vector<char>& behindGhosts, std::vector<char>& ghostsDir, std::vector<char>& behindFruit);
	void ghostAndPacMeeting(std::vector<char>& behindGhosts);
	void fruitsAndOtherCreaturesMeeting(int& fruitStepsCounter, std::vector<char>& behindFruit);
